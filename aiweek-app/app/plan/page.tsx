      ...
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        {events.length === 0 ? (
          <div className="mt-8 rounded-2xl border border-stone-200 bg-white p-8 text-center">
            ...
            <Link
              href="/gallery"
              className="mt-4 inline-flex min-h-[44px] items-center rounded-full bg-primary-bright px-6 py-2.5 font-semibold text-white hover:bg-primary-ink"
            >
              Browse events
            </Link>
          </div>
          ...
          <>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="inline-flex min-h-[44px] items-center rounded-full border border-primary-bright/60 px-5 py-2 text-sm font-semibold text-primary hover:bg-primary-soft"
              >
                ⬇ Download all (.ics)
              </button>
            </div>
